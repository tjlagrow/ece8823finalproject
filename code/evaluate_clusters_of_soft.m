function evaluate_clusters_of_soft(clusters_to_evaluate,number_of_rand_initalization,toysylvania_information,newflormedium_information,isPlot,isDisplay,numReplicates)
...
for j = 1:number_of_rand_initalization
    ...
    for i = 1:length(clusters_to_evaluate)
        ...
        [toysylvania_people_in_clusters_soft_L1, toysylvania_clusters_idx_soft_L1, toysylvania_cluster_centers_soft_L1] = ...
            soft_start_kmeans(toysylvania_information,clusters,numReplicates,isP,isDetails);                       
        ...
        [newflormedium_people_in_clusters_soft_L1, newflormedium_clusters_idx_soft_L1, newflormedium_cluster_centers_soft_L1] = ...
            soft_start_kmeans(newflormedium_information,clusters,numReplicates,isP,isDetails);                       
...
if isPlot
    ...
    title('New Flormedium, Soft Start'),
end
