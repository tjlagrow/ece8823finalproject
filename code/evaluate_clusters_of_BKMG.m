function evaluate_clusters_of_BKMG(clusters_to_evaluate,number_of_rand_initalization,toysylvania_information,newflormedium_information,isPlot,isDisplay,numReplicates)
