function evaluate_clusters_of_standard(clusters_to_evaluate,number_of_rand_initalization,toysylvania_information,newflormedium_information,isPlot,isDisplay,numReplicates)
...
for j = 1:number_of_rand_initalization
    ...
    for i = 1:length(clusters_to_evaluate)
        ...
        [toysylvania_people_in_clusters_soft_L1, toysylvania_clusters_idx_soft_L1, toysylvania_cluster_centers_soft_L1] = ...
            standard_kmeans_alg(toysylvania_information,clusters,numReplicates,isP,isDetails);                       
        ...
        [newflormedium_people_in_clusters_soft_L1, newflormedium_clusters_idx_soft_L1, newflormedium_cluster_centers_soft_L1] = ...
            standard_kmeans_alg(newflormedium_information,clusters,numReplicates,isP,isDetails);                       
...
if isPlot
    ...
    title('Toysylvania, Standard Kmeans'),
    ...
    title('New Flormedium, Standard Kmeans'),
end
