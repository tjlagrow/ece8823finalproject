function evaluate_clusters_of_soft_L2(clusters_to_evaluate,number_of_rand_initalization,toysylvania_information,newflormedium_information,isPlot,isDisplay,numReplicates)
...
for j = 1:number_of_rand_initalization
    ...
    for i = 1:length(clusters_to_evaluate)
        ...
        [toysylvania_people_in_clusters_soft_L1, toysylvania_clusters_idx_soft_L1, toysylvania_cluster_centers_soft_L1] = ...
            soft_start_L2_min_kmeans(toysylvania_information,clusters,numReplicates,isP,isDetails);                       
        [~, ~, L2_toysylvania] = evaluate_compactness(...
                                                    toysylvania_people_in_clusters_soft_L1, ...
                                                    toysylvania_cluster_centers_soft_L1);

        toysylvania_L1 = [toysylvania_L1; L2_toysylvania];

        %%% newflormedium
        isP = 0; isDetails = 0;
        [newflormedium_people_in_clusters_soft_L1, newflormedium_clusters_idx_soft_L1, newflormedium_cluster_centers_soft_L1] = ...
            soft_start_L2_min_kmeans(newflormedium_information,clusters,numReplicates,isP,isDetails);                       
        [~, ~, L2_newflormedium] = evaluate_compactness(...
                                                    newflormedium_people_in_clusters_soft_L1, ...
                                                    newflormedium_cluster_centers_soft_L1);

        newflormedium_L1 = [newflormedium_L1; L2_newflormedium];
...
if isPlot
    ...
    title('Toysylvania, Soft Start with L2 Minimization'),
    ...
    title('New Flormedium, Soft Start with L2 Minimization'),
end
